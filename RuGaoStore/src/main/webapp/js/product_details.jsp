...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        ...
        <div id="icon_all">
            <ul id="icon_list">
                <li class="i1"><img src="${basePath}/images/product_detail/product_detail_img1.jpg"/></li>
                <li class="i1"><img src="${basePath}/images/product_detail/product_detail_img2.jpg"/></li>
                <li class="i1"><img src="${basePath}/images/product_detail/product_detail_img3.jpg"/></li>
                <li class="i1"><img src="${basePath}/images/product_detail/product_detail_img4.jpg"/></li>
                <li class="li"><img src="${basePath}/images/product_detail/product_detail_img5.jpg"/></li>
            </ul>
        </div>
    </div>
    <!-- 右侧-->
    <div class="right_detail lf">
        ...
        <div class="shops">
            ...
            <a href="#" class="collection lf" id="collect"><span>收藏</span></a><b><img src="${basePath}/images/product_detail/product_detail_img6.png"                                                                       alt=""/></b>
        </div>
    </div>
</div>
<!--为你推荐-->
            ...
            <!-- 第一个宽度显示 -->
                 ...
                 <div class="detail_1 lf">
                    <div class="detail_img1">
                        <img src="${basePath}${goods.image}" border="0">
                    </div>
                    <p>${goods.title }</p>
                </div>
                </c:forEach>
...
<div id="iteminfo">
    <div id="tab">
        ...
        <div class="cart rt">
            <img src="${basePath}/images/product_detail/product_detail_img9.png" alt=""/>
        </div>
    </div>
    <div class="left lf">
        <div class="all">
            ...
            <div id="parm">
                <div id="specification_parameter">
                    <p>
                        规格参数
                        <img src="${basePath}/images/product_detail/product_detail_icon_1.png" alt="" class="ys5"/>
                    </p>
            ...
            <div id="product_introduction">
                <p>
                    商品介绍
                    <img src="${basePath}/images/product_detail/product_detail_icon_4.png" alt="" class="ys5"/>
                </p>
                <img src="${basePath}/images/product_detail/product_detail_img8.png" alt=""/>
            </div>
            ...
            <div id="packing_list">
                <p>
                    包装清单
                    <img src="${basePath}/images/product_detail/product_detail_icon_2.png" alt="" class="ys5"/>
                </p>
    ...
    <div class="right rt">
        <div class="aside_nav">
            <p><i><img src="${basePath}/images/product_detail/product_detail_icon_g_1.png" alt=""/></i><a href="#specification_parameter">规格参数</a></p>
            <p><i><img src="${basePath}/images/product_detail/product_detail_icon_t_1.png" alt=""/></i><a href="#product_introduction">商品介绍</a></p>
            <p><i><img src="${basePath}/images/product_detail/product_detail_icon_d_1.png" alt=""/></i><a href="#sale_protection">售后保障</a></p>
            <p><i><img src="${basePath}/images/product_detail/product_detail_icon_bao_1.png" alt=""/></i><a href="#sale_protect">包装清单</a></p>
