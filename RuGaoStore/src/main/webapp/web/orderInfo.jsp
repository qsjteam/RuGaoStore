...
<div id="container">
        ...
        <div id="orderStatusChart">
              <dl>
                  <dt><img src="${basePath}/images/orderinfo/orderinfo_img1_2.png" alt=""/></dt>
                  <dd>
                      <p>提交订单</p>
              ...
              <dl>
                <dt class="point"><img src="${basePath}/images/orderinfo/orderinfo_img6_2.png" alt=""/></dt>
              </dl>

              <dl>
                  <dt><img src="${basePath}/images/orderinfo/orderinfo_img2_1.png" alt=""/></dt>
                  <dd>
                      <p>付款成功</p>
                      <span>2016.01.01 13:00</span>
                  </dd>
              ...
              <dl>
                <dt class="point"><img src="${basePath}/images/orderinfo/orderinfo_img6.png" alt=""/></dt>
              </dl>

              <dl>
                  <dt><img src="${basePath}/images/orderinfo/orderinfo_img3.png" alt=""/></dt>
                  <dd>
              ...
              <dl>
                  <dt><img src="${basePath}/images/orderinfo/orderinfo_img4.png" alt=""/></dt>
                  <dd >
            ...
            <dl>
                  <dt><img src="${basePath}/images/orderinfo/orderinfo_img5.png" alt=""/></dt>
                  <dd >
        ...
        <div style="width: 1000px; margin:0px auto">
            ...
            <div class="product_confirm">
                ...
                <ul class="item_detail">
                    <li class="p_info">
                        <b><img src="${basePath}/images/orderinfo/product_simg1.png" /></b>
